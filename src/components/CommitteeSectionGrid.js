...
export default class CommitteeSectionGrid extends React.Component {
    render() {
        ...
        const paddingTop = _.get(section, 'padding_top', 'small');
            ...
            >
                ...
                {(title || subtitle) && (
                    ...
                    >
                        ...
                        {subtitle && <p className={styles.element}>{subtitle}</p>}
                    </div>
                )}
                {!_.isEmpty(gridItems) && (
                    <div className="container">
                        <div
                            className={classNames('grid', {
                                ...
                                'grid-gap-large': gridGapX === 'small'
                            })}
                        >
                            {_.map(gridItems, (item, index) => (
                                <CommitteeGridItem key={index} item={item} section={section} />
                            ))}
                        </div>
                    </div>
                )}
